...
featuredImage: "/media/maploading/map_race.webp"
...
{{< image src="/media/maploading/slowloading.avif" alt="GIF of a slow loading map" caption="A slow loading map" >}}
...
{{< image src="/media/maploading/painting_map.webp" alt="A artist painting a map" caption="A artist painting a map" >}}
...
{{< image src="/media/maploading/screenshot_frame.webp" alt="Screenshot of the online tool" >}}
