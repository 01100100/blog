...
featuredImage: ""
featuredImagePreview: "/media/maphopping/all_maps_greenwich.avif"
...
{{< image src="/media/maphopping/maphopping_skiguru_komoot.avif" alt="Trying to line up Komoot with SkiGuru" caption="Trying to line up Komoot with SkiGuru" >}}
...
{{< image src="/media/maphopping/mapswap.avif" alt="Screen capture of MapSwap Demo" caption="MapSwap Demo" >}}
...
{{< image src="/media/maphopping/all_maps_greenwich.avif" alt="Screencapture of map hopping in Greenwich, London" caption="Map hopping in Greenwich, London" >}}
